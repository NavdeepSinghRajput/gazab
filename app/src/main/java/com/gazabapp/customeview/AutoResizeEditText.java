...
public class AutoResizeEditText extends EditText_custom
{
    ...
    public AutoResizeEditText(final Context context, final AttributeSet attrs,final int defStyle)
    {
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP,16, getResources().getDisplayMetrics());
