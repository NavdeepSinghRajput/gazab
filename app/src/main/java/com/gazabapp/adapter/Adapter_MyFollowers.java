...
public class Adapter_MyFollowers extends BaseAdapter
{
    private LayoutInflater inflater;
    private Context context;
    private ArrayList<FollowUsersData> arrayList = new ArrayList<>();

    public Adapter_MyFollowers(Context context, ArrayList<FollowUsersData> arrayList)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            convertView = inflater.inflate(R.layout.row_profile_myfollowers, parent, false);
