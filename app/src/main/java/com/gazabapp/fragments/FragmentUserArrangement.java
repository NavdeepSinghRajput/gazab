...
public class FragmentUserArrangement extends Fragment
{


    private SharedPreferences sharedPref = null;
    private WebView webview;
    public FragmentUserArrangement()
    {
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_user_arrangement, container, false);
    ...
    private void getUserArrangement()
    {
        ...
        Call<PrivacyPolicy> apiRequest = getApi.getUserArrangement();
